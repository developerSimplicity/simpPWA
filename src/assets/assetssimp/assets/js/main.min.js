...
jQuery(document).ready(function(a) {
    ...
    a("body").hasClass("page-template-template-about") ? a("body").addClass("is-first") : 
    a("body").hasClass("page-template-template-services") ? a("body").addClass("is-second") : 
    a("body").hasClass("page-template-template-work") ?  a("body").addClass("is-third") : 
    a("body").hasClass("page-template-template-contact") ? a("body").addClass("is-fourth") :
    a("body").hasClass("page-template-template-services") &&  a("body").addClass("is-fifth");
    p = function(o, i, n) {
